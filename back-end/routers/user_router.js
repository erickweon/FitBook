...
exports.userRouter.post("/login", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const password = bcrypt_1.default.compareSync(
      req.body.password,
      user.password
    );
    if (!password) {
...
exports.userRouter.get("/find", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.userRouter.delete("/delete", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const email = req.query.email;
...
exports.userRouter.patch("/update/age", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.userRouter.patch("/update/weight", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.userRouter.patch("/update/height", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.userRouter.patch("/create/follow", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.userRouter.patch("/remove/follow", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const followed = req.body.followed_email;
    const follower = req.body.follower_email;
    if (followed === undefined || follower === undefined) {
