...
- Sprint Planning meeting (sprintN.md) (max 2 marks)
  ...
  > Team capacity is not recorded + Individual task breakdown not clear
...
- Broken down into tasks/subtasks (max 2 marks)
  ...
  > FB-102 - FB-104 should have been 1 user story that is broken into pieces
...
- Estimated (max 2 marks)
  ...
  > I cannot see any stories that have point estimation?
...
- Prioritized (max 2 marks)
  ...
  > All stories have medium priority?
...
- Tasks Distribution (max 3 marks)
  ...
  > Some team members do not have any tasks that are in the done part of your JIRA board
...
- Branch Naming (max 2 marks)
  ...
  > Your branch names should include the JIRA ticket so they can be conected to each other
  > You should be able to see the branch appear on JIRA
...
> I believe you should have gotten more functionalies completed, (Signup / Signin) is coupled together as one imo
...
- Attendance (max 2 marks)
  ...
  - 2 people not present, they have a midterm (Henry, and Jeremy)
...
- Documentation (max 2 marks) - 2 marks = documentation has been created for frontend and backend systems with great detail
