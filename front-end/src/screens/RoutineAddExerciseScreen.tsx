import {
  ...
  type Props = NativeStackScreenProps<RootStackParamList, 'RoutineAddExercise'>;
  ...
  const RoutineAddExerciseScreen = ({route, navigation: {navigate}}: Props) => {
    ...
    useEffect(() => {
      const backAction = () => {
        navigate('CreateRoutine', {navData: navData});
        return true;
      };
            ...
            <Pressable
              ...
              onPress={() =>
                Object.keys(newData).length
                  ? navigate('CreateRoutine', {navData: newData})
                  : undefined
              }
